					...
					<!-- Basic Forms -->
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">New Password</h4>
						</div>
						<!-- /.box-header -->
						<form method="POST" >
							<div class="box-body">
								<h4 class="mt-0 mb-20">Password</h4>
							...
							<div class="box-footer">
								<button type="submit"class="btn btn-rounded btn-success pull-right">Change Password</button>
							</div>
						</form>
